                                ...
                                <form action="#" method="POST" id="media_form" enctype="multipart/form-data">
                                    ...
                                    <div style="border-style: dashed;text-align: center; height:200px;padding-top:30px" >
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input  type="file"
                                            class="form-control" name="upload_image" id="upload_image"
                                                multiple="" accept="image/jpeg,.jpg,.jpeg,image/gif,.gif,image/png,.png">
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.status == 200) {
                            ...
                            $("#addmedia_btn").val('Save as Draft');
                            $("#addmedia_alert").css("display", "block").delay(2000).fadeOut(400);
                            window.location='{{route('addfeatures')}}'
                        }
                    }
                });
            });
