...
@section('content')
    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="#" method="POST" id="amenities_form">
                                    @csrf
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Amenity List</h1>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                ...
                $.ajax({
                    ...
                    success: function(res) {                    
                        if (res.status == 200) {
                            ...
                            $("#amenities_form")[0].reset();
                            removeValidationClasses("#amenities_form");
                            $("#addamenity_btn").val('Add');
                            $("#addbedrooms_alert").css("display", "block").delay(2000).fadeOut(400);
                           //  window.location = '/addamenities'
                           // { $amenitiesdata.push(rea.data) }
                           var jobs = @json($amenitiesdata);
                           jobs.push(res.data);
                           $amenitiesdata=jobs;
