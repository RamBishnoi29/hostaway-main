                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="#" method="POST" id="terms_form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <label for="terms_title">Arrival Time End?</label>
                                            <select name="check_in_time_end" class="form-control" id="check_in_time_end"
                                                data-live-search="false" title="Select" tabindex="-98">
                                                <option class="bs-title-option" value="">Select</option>
                                                <option value="8:00 AM">8:00 AM</option>
                                                <option value="9:00 AM">9:00 AM</option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-2 mb-sm-0">
                                                    <input type="radio" class="" id="smoking_allowed"
                                                        value="1" name="smoking_allowed"> <label
                                                        for="terms_title">Yes</label>
                                                </div>
                                                <div class="col-sm-8 mb-4 mb-sm-0">
                                                    <input type="radio" class="" id="smoking_allowed"
                                                        value="0" name="smoking_allowed"> <label for="terms_title">
                                                        No</label>
                                                </div>
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-2 mb-sm-0">
                                                    <input type="radio" class="" id="pets_allowed"
                                                        value="1" name="pets_allowed"> <label
                                                        for="terms_title">Yes</label>
                                                </div>
                                                <div class="col-sm-8 mb-4 mb-sm-0">
                                                    <input type="radio" class="" id="pets_allowed"
                                                        value="0" name="pets_allowed"> <label for="terms_title">
                                                        No</label>
                                                </div>
                                            </div>
                                            <div class="invalid-feedback"></div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-2 mb-sm-0">
                                                    <input type="radio" class="" id="party_allowed"
                                                        value="1" name="party_allowed"> <label
                                                        for="terms_title">Yes</label>
                                                </div>
                                                <div class="col-sm-8 mb-4 mb-sm-0">
                                                    <input type="radio" class="" id="party_allowed"
                                                        value="0" name="party_allowed"> <label for="terms_title">
                                                        No</label>
                                                </div>
                                            </div>
                                            <div class="invalid-feedback"></div>
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 mb-2 mb-sm-0">
                                                    <input type="radio" class="" id="safe_for_children"
                                                        value="1" name="safe_for_children"> <label
                                                        for="terms_title">Yes</label>
                                                </div>
                                                <div class="col-sm-8 mb-4 mb-sm-0">
                                                    <input type="radio" class="" id="safe_for_children"
                                                        value="0" name="safe_for_children"> <label
                                                        for="terms_title">
                                                        No</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-6 mb-sm-0">
                                            <label for="terms_title">Additional House Rules Information (Optional)</label>
