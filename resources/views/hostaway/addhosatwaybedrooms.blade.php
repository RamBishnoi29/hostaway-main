...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Listing Hostaway</h1>
        </div>
                                                        ...
                                                        <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="extra_bedroom[0][bed_type]"
                                                                    ...
                                                                    data-live-search-style="begins" tabindex="2">
                                                                    <option selected="selected" value="0">Select Bed
                                                                        Type</option>
                                                                    @foreach ($bedTypedata as $item)
                                                                        <option value="{{ $item['hostaway'] }}">
                                                                            {{ $item['name'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
...
@section('customscript')
    <script>
        $(document).ready(function() {
            var i = 1;
            var j = "";
            var values = {!! $bedTypedata !!};
            for (var q = 0; q < values.length; q++) {
                j = j + "<option value=" + values[q].id + ">" + values[q].name + "</option>";
            }
                    ...
                    success: function(res) {
                        ...
                        if (res.status == 200) {
                            ...
                            $("#addbedrooms_alert").css("display", "block").delay(2000).fadeOut(
                                400);
                            window.location = '/addhostawayterms'
                        }
                    }
                });
            });
